  ...
  return (
    <>
      ...
      <img
        ...
        className="absolute top-[100px] -right-16 w-[400px] overflow-visible blur-md brightness-110 md:w-[640px]"
      />
    </>
  );
};
  ...
  return (
    <>
      ...
      <img
        ...
        alt="shooting stars"
        className="absolute top-[5rem] w-[500px] lg:right-[10rem] lg:w-[700px]"
      />
      <img
