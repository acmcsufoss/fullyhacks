  ...
  return (
    <section className="relative z-0 font-audiowide">
      ...
      <div
        ...
        <h2 className="text-lg font-bold sm:text-xl">About</h2>

        <p className="rounded-2xl bg-[#7F7F7F] p-2 pb-6 text-xs font-semibold sm:mt-2 sm:text-[1rem] sm:leading-relaxed">
