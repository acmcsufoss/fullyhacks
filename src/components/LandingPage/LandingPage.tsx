    ...
    <SignArea signs={SIGNS}>
      <main className="relative flex flex-col items-center font-rubik font-semibold">
        ...
        <section>
          ...
          <div
            id="team"
            className="mx-4 font-normal font-rubik text-purple_main mt-8 flex flex-col items-center md:items-start justify-center md:mx-8 md:text-md max-w-[1048px] md:mt-40">
            <Team team={teamData} />
          </div>
        </section>
